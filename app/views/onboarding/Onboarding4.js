  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.contentContainer}>
        <Text style={styles.headerText}>{languages.t('label.launch_screen4_header')}</Text>
        <Text style={styles.subheaderText}>{languages.t('label.launch_screen4_subheader')}</Text>
      </View>
